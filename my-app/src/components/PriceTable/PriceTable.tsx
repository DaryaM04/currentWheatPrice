...
interface PriceTableProps {
    priceRostov: (number | string)[],
    setPricesRostov: React.Dispatch<React.SetStateAction<(number | string[])>>;
    priceTarasov: (number | string)[],
    setPricesTarasov: React.Dispatch<React.SetStateAction<(number | string[])>>;
}

const PriceTable: React.FC<PriceTableProps> = ({pricesRostov, setPricesRostov, pricesTarasov, setPricesTarasov}) => {
